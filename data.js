 ...
 */
const resumeData = {
  profilePhoto: "assets/profile-placeholder.svg", // TODO: replace with your actual photo file (e.g. assets/profile.jpg)
  defaultLang: "zh-Hant",
  ...
  evidence: [
    {
      ...
      type: "website",
      title: {
        "zh-Hant": "Computex 公司網站測試版（bakewithmeow）",
        en: "Computex company website test build (bakewithmeow)"
      },
      description: {
        "zh-Hant": "目前為 Computex 測試網址，後續將正式上架至新網域。",
        en: "Currently on a Computex test URL; it will be migrated to a new production domain later."
      },
      link: "",
      visible: true
    },
